...
class WalletPayment extends StatefulWidget {
  const WalletPayment({Key? key, this.products}) : super(key: key);
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                final _service = KhaltiService(client: KhaltiHttpClient());
                final initiationModel = await _service.initiatePayment(
